...
// Radius of the circle to which the graph is generated by default
const RADIUS = 200;
...
class NetworkGraph extends React.Component {
    ...
    /**
     * Does one edge insertion in demo mode
     *
     * @returns {Promise<void>}
     */
    async step() {
    ...
    /**
     * Action taken when button "cancel demo" is clicked
     *
     * @returns {Promise<void>}
     */
    async cancelDemo() {
    ...
    /**
     * Responsible for rendering app on the screen
     *
     * @returns {JSX.Element}
     */
    render() {
